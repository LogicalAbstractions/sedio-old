...
7z a -tzip -saa ..\..\..\sedio-server-linux-x64-%APPVEYOR_BUILD_VERSION% ..\..\..\publish\server\linux-x64\*
7z a -tzip -saa ..\..\..\sedio-server-osx-x64-%APPVEYOR_BUILD_VERSION% ..\..\..\publish\server\osx-x64\*
7z a -tzip -saa ..\..\..\sedio-server-win-x64-%APPVEYOR_BUILD_VERSION% ..\..\..\publish\server\win-x64\*
...
7z a -tzip -saa ..\..\..\sedio-agent-linux-x64-%APPVEYOR_BUILD_VERSION% ..\..\..\publish\agent\linux-x64\*
7z a -tzip -saa ..\..\..\sedio-agent-osx-x64-%APPVEYOR_BUILD_VERSION% ..\..\..\publish\agent\osx-x64\*
7z a -tzip -saa ..\..\..\sedio-agent-win-x64-%APPVEYOR_BUILD_VERSION% ..\..\..\publish\agent\win-x64\*
