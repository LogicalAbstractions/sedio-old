        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HealthAggregation_ParametersJson = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Notification_ParametersJson = table.Column<string>(nullable: true),
                    InstanceRouting_ProviderId = table.Column<string>(maxLength: 48, nullable: false),
                    InstanceRouting_ParametersJson = table.Column<string>(nullable: true),
                    InstanceRetirement_ProviderId = table.Column<string>(maxLength: 48, nullable: false),
                    InstanceRetirement_ParametersJson = table.Column<string>(nullable: true),
                    Orchestration_ProviderId = table.Column<string>(maxLength: 48, nullable: false),
                    Orchestration_ParametersJson = table.Column<string>(nullable: true),
                    CacheTime = table.Column<TimeSpan>(nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(nullable: false),
