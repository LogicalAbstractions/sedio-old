...
namespace Sedio.Core.Runtime.Dns.Protocol
{
    public class DefaultResponse : IResponse
    {
        ...
        public static DefaultResponse FromRequest(IRequest request)
        {
        ...
        public static DefaultResponse FromArray(byte[] message)
        {
            ...
            if (header.Truncated)
            {
                return new DefaultResponse(header,
        ...
        public DefaultResponse(Header header, IList<Question> questions, IList<IResourceRecord> answers,
