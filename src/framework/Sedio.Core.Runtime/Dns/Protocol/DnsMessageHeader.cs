...
namespace Sedio.Core.Runtime.Dns.Protocol
{
    ...
    public struct DnsMessageHeader
    {
        ...
        public static DnsMessageHeader FromArray(byte[] header)
        {
            ...
            return Marshalling.Struct.GetStruct<DnsMessageHeader>(header, 0, SIZE);
        }
        ...
        public int Size
        {
            get { return DnsMessageHeader.SIZE; }
        }
