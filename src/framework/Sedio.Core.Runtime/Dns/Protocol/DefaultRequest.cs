...
namespace Sedio.Core.Runtime.Dns.Protocol
{
    public class DefaultRequest : IRequest
    {
        ...
        public static DefaultRequest FromArray(byte[] message)
        {
            ...
            return new DefaultRequest(header,
        ...
        public DefaultRequest(Header header, IList<Question> questions, IList<IResourceRecord> additional)
        {
            this.header = header;
