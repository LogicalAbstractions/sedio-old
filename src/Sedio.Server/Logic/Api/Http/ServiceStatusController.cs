...
namespace Sedio.Server.Logic.Api.Http
{
    ...
    public class ServiceStatusController : Controller
    {
        ...
        public async Task<ActionResult> Put(ServiceId serviceId, SemanticVersion serviceVersion, IPAddress serviceInstanceAddress,[FromBody]ServiceStatusInputDto serviceStatusDescription)
        {
            return Ok();
        }
    }
